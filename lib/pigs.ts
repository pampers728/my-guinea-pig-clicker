...
export const PIGS: PigData[] = [
  ...
  },
  {
    ...
    icon: "/images/img-20251228-165157-1-1.png",
    description: {
      en: "Limited edition tattoo pig v2",
      ru: "Лимитированная свинка с татуировкой v2",
      uk: "Лімітована свинка з татуюванням v2",
    },
    unlockLevel: 25,
    source: "level",
  },
  {
    id: "brown_basic",
    name: { en: "Brown Pig", ru: "Коричневая свинка", uk: "Коричнева свинка" },
    rarity: "COMMON",
    icon: "/images/img-20251228-164730-075.png",
    description: {
      en: "Basic brown guinea pig",
      ru: "Базовая коричневая морская свинка",
      uk: "Базова коричнева морська свинка",
    },
    unlockLevel: 20,
    source: "level",
  },
